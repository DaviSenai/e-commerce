...
class Item {
    ...
    constructor(name, qtyAvailable, qtyPerUnity, price, category, measure, place, description, img) {
        ...
        this.price = Number.parseFloat(price).toPrecision(3);
    ...
    static saveEdit(id) {
        ...
        item.price = Number(price).toPrecision(3);
        ...
        item.img = document.getElementById("editImg").innerText;
        Inventory.refresh();
    ...
    static add() {
        ...
        let img = document.getElementById("editImg").innerText;
...
const Menu = {
    ...
    models:{   
            ...
            let tableContent = `
                ...
                <div style="display:flex; overflow-y: hidden; max-width: 80vw; max-height: 60vh;">
                    <table style="display: flex;">
                        <tbody style="display: block; overflow-y: auto; max-height: 60vh;">
                            <tr>
                                <td>Nome</td>
                                <td>${item.name}</td>
                            </tr>
        ...
        editItemInfo(id) {
            ...
            let tableContent = `
                ...
                <table>
                    <tbody>
                        ...
                        <tr>
                            <td>Imagem</td>
                            <td><p id="editImg" contentEditable="true" style="display:flex; overflow:hidden">${item.img}</p></td>
                        </tr>
                    </tbody>
                </table>
            ...
            document.querySelector("table p").addEventListener('keydown', (e) => {
                if (e.key == "Enter") {
                    e.preventDefault() ;
                }
            })
            ...
            let tableContent = `
                ...
                <table>
                    <tbody>
                        ...
                        <tr>
                            <td>Imagem</td>
                            <td><p id="editImg" contentEditable="true" style="display:flex; overflow:hidden"></p></td>
                        </tr>
                    </tbody>
                </table>
                <div style="display:flex; justify-content: end;">
        ...
        removeItem(id) {
            let tableContent = `
                ...
                <div style="display:flex; justify-content: end;">
                    <button class="simpleButton" style="background: transparent" onclick="Item.remove(${id}); Menu.switch();">Confirmar</button>
                    <button class="simpleButton" style="color: white; background: linear-gradient(to right, #006175 0%, #00a950 100%)" onclick="Menu.switch()">Cancelar</button>
                </div>
            `;
            Menu.setContent(tableContent);
            Menu.isOpened = true;
